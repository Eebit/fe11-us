...
EC void StartFadeIn(struct Proc * proc, u16 data, u32 flag);
EC void StartFadeOut(struct Proc * proc, u16 data, u32 flag);
EC void StartBlockingFadeIn(struct Proc * proc, u16 data, u32 flag);
EC void StartBlockingFadeOut(struct Proc * proc, u16 data, u32 flag);
EC void StartFadeIn_0201d860(struct Proc * proc, u16 data, u32 flag);
EC void StartFadeOut_0201d8b0(struct Proc * proc, u16 data, u32 flag);
EC void StartBlockingFadeIn_0201d900(struct Proc * proc, u16 data, u32 flag);
EC void StartBlockingFadeOut_0201d950(struct Proc * proc, u16 data, u32 flag);
