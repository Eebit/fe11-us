...
{
public:
    /* 14 */ virtual s32 vfunc_14(void); // func_ov000_021bf8a4
    /* CC */ virtual u32 vfunc_c4(void); // func_ov000_021bf8b4
    /* CC */ virtual u32 vfunc_cc(void); // func_ov000_021bf8ac
};
...
{
    /* 000 */ virtual void vfunc_00(void); // func_ov000_021bf88c
    /* 008 */ virtual void vfunc_08(void); // func_ov000_021be588
    /* 01C */ virtual void vfunc_1c(void); // func_ov000_021be640
    /* 024 */ virtual s32 vfunc_24(MenuItemState * menuItemState, s32 arg1); // func_ov000_021bf574
    /* 028 */ virtual s32 vfunc_28(s32 arg0); // func_ov000_021bf544
    /* 0A0 */ virtual BOOL vfunc_a0(void); // func_ov000_021be978
    /* 0AC */ virtual s32 vfunc_ac(void); // func_ov000_021be960
    /* 0D8 */ virtual void vfunc_d8(void); // func_ov000_021bf5d4
    /* 0DC */ virtual void vfunc_dc(void); // func_ov000_021bf57c
    /* 0E8 */ virtual void vfunc_e8(void); // func_ov000_021bf7e8
    /* 0EC */ virtual void vfunc_ec(void); // func_ov000_021bf75c
...
class MIM_UnitList : public MenuItem
{
    ...
    /* 14 */ virtual s32 vfunc_14(void); // func_ov000_021bf458
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bf3ec
    /* 78 */ virtual void vfunc_78(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf410
    /* 90 */ virtual void vfunc_90(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf42c
};

class MIM_TutList : public MenuItem
{
    /* 00 */ virtual char * vfunc_00(void); // func_ov000_021bf3d8
    /* 14 */ virtual s32 vfunc_14(void); // func_ov000_021bf3a0
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bf334
    /* 78 */ virtual void vfunc_78(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf358
    /* 90 */ virtual void vfunc_90(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf374
};

class MIM_Config : public MenuItem
{
    /* 00 */ virtual char * vfunc_00(void); // func_ov000_021bf320
    /* 14 */ virtual s32 vfunc_14(void); // func_ov000_021bf308
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bf29c
    /* 78 */ virtual void vfunc_78(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf2c0
    /* 90 */ virtual void vfunc_90(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf2dc
};

class MIM_TemporarySave : public MenuItem
{
    /* 00 */ virtual char * vfunc_00(void); // func_ov000_021bf1d8
    /* 10 */ virtual s32 vfunc_10(MenuItemState * menuItemState); // func_ov000_021bf1c0
    /* 14 */ virtual s32 vfunc_14(void); // func_ov000_021bf184
    /* 24 */ virtual s32 vfunc_24(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf0f4
    /* 78 */ virtual void vfunc_78(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf11c
    /* 90 */ virtual void vfunc_90(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf148
};

class MIM_Surrender : public MenuItem
{
    /* 00 */ virtual char * vfunc_00(void); // func_ov000_021bf070
    /* 10 */ virtual s32 vfunc_10(MenuItemState * menuItemState); // func_ov000_021bf058
    /* 14 */ virtual s32 vfunc_14(void); // func_ov000_021bf040
    /* 24 */ virtual s32 vfunc_24(Menu * menu, MenuItemState * menuItemState); // func_ov000_021befd0
    /* 78 */ virtual void vfunc_78(Menu * menu, MenuItemState * menuItemState); // func_ov000_021beff8
    /* 90 */ virtual void vfunc_90(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bf014
};

class MIM_TurnEnd : public MenuItem
{
    /* 00 */ virtual char * vfunc_00(void); // func_ov000_021befbc
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bef50
    /* 78 */ virtual void vfunc_78(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bef74
    /* 90 */ virtual void vfunc_90(Menu * menu, MenuItemState * menuItemState); // func_ov000_021bef90
};
...
{
    /* 0C0 */ virtual void vfunc_c0(void); // func_ov000_021bef1c
};

class BMapSallyEndYes : public DialogItemNo
{
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bef00
};

class BMapSallyEndNo : public DialogItemNo
{
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bee60
};
...
// func_ov000_021bee60
s32 BMapSallyEndNo::vfunc_1c(void)
{
...
// func_ov000_021bef00
s32 BMapSallyEndYes::vfunc_1c(void)
{
...
// func_ov000_021bef1c
void BMapSallyEndYesNo::vfunc_c0(void)
{
...
// func_ov000_021bef50
s32 map::MIM_TurnEnd::vfunc_1c(void)
{
...
// func_ov000_021bef74
void map::MIM_TurnEnd::vfunc_78(Menu * menu, MenuItemState * menuItemState)
{
...
// func_ov000_021bef90
void map::MIM_TurnEnd::vfunc_90(Menu * menu, MenuItemState * menuItemState)
{
...
// func_ov000_021befbc
char * map::MIM_TurnEnd::vfunc_00(void)
{
    // "End"
...
// func_ov000_021befd0
s32 map::MIM_Surrender::vfunc_24(Menu * menu, MenuItemState * menuItemState)
{
...
// func_ov000_021beff8
void map::MIM_Surrender::vfunc_78(Menu * menu, MenuItemState * menuItemState)
{
...
// func_ov000_021bf014
void map::MIM_Surrender::vfunc_90(Menu * menu, MenuItemState * menuItemState)
{
    if (func_0202dad0(menuItemState, menu))
    {
        // "Surrender and end wireless play."
...
// func_ov000_021bf040
s32 map::MIM_Surrender::vfunc_14(void)
{
...
// func_ov000_021bf058
s32 map::MIM_Surrender::vfunc_10(MenuItemState * menuItemState)
{
    if ((menuItemState->unk_09 & 7) != 1)
    {
        return 5;
...
// func_ov000_021bf070
char * map::MIM_Surrender::vfunc_00(void)
{
    // "Surrender"
...
namespace map
{
class DI_Surrender : public MenuItem
{
public:
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bf084
};
...
{
    /* 0B8 */ virtual void vfunc_b8(s32 arg0); // func_ov000_021bf0bc
...
// func_ov000_021bf084
s32 map::DI_Surrender::vfunc_1c(void)
{
    func_ov000_021d6dfc(0);
...
// func_ov000_021bf0bc
void map::SurrenderDialogYesNo::vfunc_b8(s32 arg0)
{
...
// func_ov000_021bf0f4
s32 map::MIM_TemporarySave::vfunc_24(Menu * menu, MenuItemState * menuItemState)
{
    if ((menuItemState->unk_09 & 7) != 1)
    {
...
// func_ov000_021bf11c
void map::MIM_TemporarySave::vfunc_78(Menu * menu, MenuItemState * menuItemState)
{
    char * str;
...
// func_ov000_021bf148
void map::MIM_TemporarySave::vfunc_90(Menu * menu, MenuItemState * menuItemState)
{
    char * str;
...
// func_ov000_021bf184
s32 map::MIM_TemporarySave::vfunc_14(void)
{
    if (func_ov000_021a478c())
    {
        return MENU_NOTSHOWN;
...
// func_ov000_021bf1c0
s32 map::MIM_TemporarySave::vfunc_10(MenuItemState * menuItemState)
{
    if ((menuItemState->unk_09 & 7) != 1)
    {
        return 5;
...
// func_ov000_021bf1d8
char * map::MIM_TemporarySave::vfunc_00(void)
{
    if (func_ov000_021a47e4())
    {
        // "Exit"
...
{
public:
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021bf208
};

} // namespace map

// func_ov000_021bf208
s32 map::DI_TemporarySave::vfunc_1c(void)
{
    func_ov000_021d6dfc(0);
...
// func_ov000_021bf264
EC void func_ov000_021bf264(void * param_1, s32 param_2)
{
...
// func_ov000_021bf29c
s32 map::MIM_Config::vfunc_1c(void)
{
...
// func_ov000_021bf2c0
void map::MIM_Config::vfunc_78(Menu * menu, MenuItemState * menuItemState)
{
    // "Adjust game options."
...
// func_ov000_021bf2dc
void map::MIM_Config::vfunc_90(Menu * menu, MenuItemState * menuItemState)
{
    if (func_0202dad0(menuItemState, menu))
    {
        // "Adjust game options."
...
// func_ov000_021bf308
s32 map::MIM_Config::vfunc_14(void)
{
    if (func_ov000_021a47e4())
    {
        return MENU_NOTSHOWN;
...
// func_ov000_021bf320
char * map::MIM_Config::vfunc_00(void)
{
    // "Options"
    return func_02039e10("MMM_降参");
}
...
// func_ov000_021bf334
s32 map::MIM_TutList::vfunc_1c(void)
{
...
// func_ov000_021bf358
void map::MIM_TutList::vfunc_78(Menu * menu, MenuItemState * menuItemState)
{
...
// func_ov000_021bf374
void map::MIM_TutList::vfunc_90(Menu * menu, MenuItemState * menuItemState)
{
    if (func_0202dad0(menuItemState, menu))
    {
        // "Review tutorials on how the game is played."
...
// func_ov000_021bf3a0
s32 map::MIM_TutList::vfunc_14(void)
{
    if (func_ov000_021a47e4())
    {
        return MENU_NOTSHOWN;
...
// func_ov000_021bf3d8
char * map::MIM_TutList::vfunc_00(void)
{
    // "Guide"
...
// func_ov000_021bf3ec
s32 map::MIM_UnitList::vfunc_1c(void)
{
...
// func_ov000_021bf410
void map::MIM_UnitList::vfunc_78(Menu * menu, MenuItemState * menuItemState)
{
...
// func_ov000_021bf42c
void map::MIM_UnitList::vfunc_90(Menu * menu, MenuItemState * menuItemState)
{
    if (func_0202dad0(menuItemState, menu))
    {
        // "Display a list of your units."
...
// func_ov000_021bf458
s32 map::MIM_UnitList::vfunc_14(void)
{
    return 0;
}

char * map::MIM_UnitList::vfunc_00(void)
{
    // "Units"
...
// func_ov000_021bf544
s32 map::MapMenu::vfunc_28(s32 arg0)
{
...
// func_ov000_021bf574
s32 map::MapMenu::vfunc_24(MenuItemState * menuItemState, s32 arg1)
{
    return arg1;
}
...
// func_ov000_021bf57c
void map::MapMenu::vfunc_dc(void)
{
    s32 iVar1;
...
// func_ov000_021bf5d4
void map::MapMenu::vfunc_d8(void)
{
    s32 uVar2;
    s32 uVar3;
    s32 iVar5;
    ...
    func_02029850(
        data_021970c4, iVar5, gpActiveScreenSt->bgTiles[this->unk_2c], gpActiveScreenSt->tilemap[this->unk_2c], 0x1e,
        iVar7, uVar3 + iVar10, uVar2, 0);
...
// func_ov000_021bf75c
void map::MapMenu::vfunc_ec(void)
{
    s32 r3;
    s32 r1;
...
// func_ov000_021bf7e8
void map::MapMenu::vfunc_e8(void)
{
    s32 var_r2;
    int iVar1;
...
// func_ov000_021bf88c
void map::MapMenu::vfunc_00(void)
{
    func_ov000_021be21c();
    this->unk_40 = 1;
    return;
...
// func_ov000_021bf8a4
s32 map::MI_Separator::vfunc_14(void)
{
    return 3;
}

// func_ov000_021bf8ac
u32 map::MI_Separator::vfunc_cc(void)
{
    return 1;
}

// func_ov000_021bf8b4
u32 map::MI_Separator::vfunc_c4(void)
{
    return 0;
}
