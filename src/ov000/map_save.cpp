...
{
public:
    /* 1C */ virtual s32 vfunc_1c(void); // func_ov000_021d6238
};
...
EC void func_ov000_021d5f80(mapsave::MapSave * param_1)
{
    func_ov000_021d59d0(param_1);
    return;
}

EC void func_ov000_021d5f8c(mapsave::MapSave * param_1)
{
    func_ov000_021d5d70(param_1);
    return;
}

EC void func_ov000_021d5f98(mapsave::MapSave * param_1)
{
    func_ov000_021d5dd4(param_1);
    return;
}

EC void func_ov000_021d5fa4(mapsave::MapSave * param_1)
{
    func_ov000_021d5e94(param_1);
    return;
}

EC void func_ov000_021d5fb0(mapsave::MapSave * param_1)
{
    func_ov000_021d5f00(param_1);
    return;
}

EC void func_ov000_021d5fbc(ProcPtr param_1)
{
    ...
    func_020303bc(new map::BMapDialogYesNo(), func_02039e10("MD_セーブ"), data_ov000_021e2574, param_1, 1, 0);
...
{
public:
    /* 24 */ virtual s32 vfunc_24(Menu * menu, MenuItemState * menuItemState); // func_ov000_021d6148
    /* 74 */ virtual void vfunc_74(MenuItemState * menuItemState); // func_ov000_021d61b8
    /* 80 */ virtual void vfunc_80(MenuItemState * menuItemState); // func_ov000_021d6188

    /* savemenuitem? */
    /* D8 */ virtual s32 vfunc_d8(void); // func_ov000_021d6230
    /* DC */ virtual s32 vfunc_dc(void); // func_ov000_021d6218
    /* E0 */ virtual s32 vfunc_e0(void); // func_ov000_021d61fc
    /* F0 */ virtual s32 vfunc_f0(void); // func_ov000_021d6130
    /* F4 */ virtual s32 vfunc_f4(void); // func_ov000_021d6118
};
...
public:
    ...
    /* 000 */ virtual void vfunc_00(void); // func_ov000_021d6460
    /* 028 */ virtual s32 vfunc_28(s32 arg0); // func_ov000_021d6350
    /* 0A0 */ virtual BOOL vfunc_a0(void); // func_ov000_021d63d4
    /* 0B8 */ virtual void vfunc_b8(s32 arg0); // func_ov000_021d639c
    /* 114 */ virtual void vfunc_114(void); // func_ov000_021d6400
...
// func_ov000_021d6118
s32 mapsave::MapPointSaveMenuItem::vfunc_f4(void)
{
...
// func_ov000_021d6130
s32 mapsave::MapPointSaveMenuItem::vfunc_f0(void)
{
...
// func_ov000_021d6148
s32 mapsave::MapPointSaveMenuItem::vfunc_24(Menu * menu, MenuItemState * menuItemState)
{
    if (func_0201f680())
    {
...
// func_ov000_021d6188
void mapsave::MapPointSaveMenuItem::vfunc_80(MenuItemState * menuItemState)
{
...
// func_ov000_021d61b8
void mapsave::MapPointSaveMenuItem::vfunc_74(MenuItemState * menuItemState)
{
    VmMap_Common * iVar1 = static_cast<VmMap_Common *>(HashTable::Get2("VmMap_FontMenuHelp"));
...
// func_ov000_021d61fc
s32 mapsave::MapPointSaveMenuItem::vfunc_e0(void)
{
    VmMap_Common * iVar1 = static_cast<VmMap_Common *>(HashTable::Get2("VmMap_Window"));
...
// func_ov000_021d6218
s32 mapsave::MapPointSaveMenuItem::vfunc_dc(void)
{
...
// func_ov000_021d6230
s32 mapsave::MapPointSaveMenuItem::vfunc_d8(void)
{
    return 0x10;
}
...
// func_ov000_021d6238
s32 mapsave::DI_PointSaveYes::vfunc_1c(void)
{
    if (func_0201f680())
    {
        func_ov000_021b0de8(
            gMapStateManager->unk_04->unk_00->xPos, gMapStateManager->unk_04->unk_00->yPos, 0x10, gActionSt->unk_37);
...
// func_ov000_021d6350
s32 mapsave::PointSaveMenu::vfunc_28(s32 arg0)
{
...
// func_ov000_021d639c
void mapsave::PointSaveMenu::vfunc_b8(s32 param_2)
{
...
// func_ov000_021d63d4
BOOL mapsave::PointSaveMenu::vfunc_a0(void)
{
...
// func_ov000_021d6400
void mapsave::PointSaveMenu::vfunc_114(void)
{
...
// func_ov000_021d6460
void mapsave::PointSaveMenu::vfunc_00(void)
{
    VmMap_Common * iVar1;
    s32 iVar3;
    u32 * uVar4;
