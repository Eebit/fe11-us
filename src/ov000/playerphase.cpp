...
EC void func_ov000_021abd9c(void)
{
        ...
        (func_ov000_021a9cac() != 0))
    {
        if (data_ov000_021e3324->unk_03 != 0)
        {
            ...
            gSoundManager->unk_b0->vfunc_28(0x0001001C, 0, 0);
        }
        else
        {
            data_ov000_021e3324->unk_03 = 1;
            gSoundManager->unk_b0->vfunc_28(0x0001001B, 0, 0);
        }
...
EC BOOL func_ov000_021ac0c0(void)
{
    ...
    gSoundManager->unk_b0->vfunc_28(0x00010017, 0, 0);
        ...
        if (func_02050474() == 0)
        {
            if ((gKeySt->pressed & KEY_BUTTON_R) != 0 || (func_ov000_021a5650(gMapStateManager->unk_0c, 1) != 0))
            {
                if (func_0204b1f8(0) != 0)
                {
                    ...
                    {
                        gSoundManager->unk_b0->vfunc_28(0x00010018, 0, 0);
                    }
                }
                else
                {
...
EC void func_ov000_021acc7c(ProcPtr proc)
{
    ...
    if (CHECK_02())
    {
        gSoundManager->unk_b0->vfunc_28(0x00010003, 0, 0);
    }
