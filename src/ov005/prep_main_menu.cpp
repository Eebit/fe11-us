...
class MIS_SallyEnd : public MenuItem
{
    ...
    virtual s32
    vfunc_10(MenuItemState *); // func_ov005_02205f2c; GetLabelColor? (1 = White, 2 = Grey, 3 = Cyan, 4 = Gold, 5 = Green)
...
public:
    ...
    MMenu()
    {
        ...
        this->unk_3c = StartButton(this, 3, 8, 1, 2);
        ...
        if (data_ov005_02217560->unk_11 != 0)
        {
            ...
            this->unk_40 = StartButton(this, 1, 0x14, 1, 2);
